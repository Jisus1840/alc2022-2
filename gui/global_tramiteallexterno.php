...
<script language="javascript">
	...
	function enviar_a_programar_cita(tramitevu_id) {
		$.ajax({
			...
			async: false,
			success: function(data) {
				alert("Expediente enviado a revisión. La Unidad Administrativa de Alcoholes te asignará la fecha y hora de tu cita y esta información te será notificada por correo electrónico");
			},
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-11 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
				...
				<br>
				<b style="background-color: #ECF9FF;"> * Una vez que hayas enviado a revisión tus documentos, se te asignará un folio y una cita (consérvalos y tráelos contigo cuando asistas a tu cita a la Unidad Administrativa de Alcoholes).</b>
				<br>
				...
				<br>
				<b style="background-color: #ECF9FF;"> *  Para ver comentarios de seguimiento del proceso de tu trámite o realizar comentarios, haz click en el ícono <i style="font-size: 1.5em;" class="icon-message"></i></b>
                <?
                //paginador
                            ...
                            foreach ($results->data as $row){
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<?php if($row['tramitevu_statusid'] == 4) { ?>
                                        ...
                                        <i id="verflujo|<?=$row['tramitevu_id']?>" style="cursor:pointer; font-size: 1.5em;" title="Ver Flujo" class="icon-time"></i>
                                              ...
                                              <!--FORMATOS -->
                                              <!-- CROQUIS -->
                                              <? if ($row['tramitevu_tipotramiteid'] == 1 or $row['tramitevu_tipotramiteid'] == 7){ ?>
