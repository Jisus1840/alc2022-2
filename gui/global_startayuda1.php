                        ...
                        <div id="cs-content" class="cs-content">
                            <div class="el56 x-section">
                                <div class="el57 x-container max width" style="color:black">
                                        <h4>Unidad Administrativa de Alcoholes</h4>
                                        <br>
                                        <!--Desarrollo página-->
                                        <? include_once "../includes/global_ayuda1.php"; ?>
                                </div>
                                
                            </div> 
                            <div id="x-section-8" class="x-section bg-image" style="margin: 0px;padding: 45px 0px; background-image: url(https://saltillo.gob.mx/wp-content/uploads/2017/12/fondo.jpg); background-color: transparent;" data-x-element="section">
