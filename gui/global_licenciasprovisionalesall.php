...
* Ver todos los permisos especiales
*********************************************************************************
*/
?>
				...
				<div class="container-fluid">
                    ...
                    <div class="row">
						<div class="col-md-12">
                            <?
                                $p = new permisos();
                                $p->revisarpermisos('1002',$usersessionpermisos);
                            ?>
							<span class="heading-meta">Trámite</span>
                            <? include_once ("../includes/global_menulicenciasprovisionales.php");?>
                    ...
                    <!-- body -->
					<? include_once ("../includes/global_licenciasprovisionalesall.php"); ?>
				</div>
			</div>
		</div>
	</div>
