        ...
        $(".altarfc").on("click",function(){
            ...
            let contenedor = document.getElementById("prueba");
                            ...
                            var html =  '<form id="MiFormularioRFC" name="MiFormularioRFC">'+
                                            ...
                                            '<input type="text" width="80%" id="direcciontext" name="direcciontext" class="form-control" placeholder="Dirección (calle)*" maxlength="250">'+
											'<input type="text" width="20%" id="direcciontextnum" name="direcciontextnum" class="form-control" placeholder="Dirección (número ext) *" maxlength="10">'+
            ...
            <div>
                <form id="MiFormulario" name="MiFormulario">
                    ...
                    <div class="form-row" align="right">
                        <div class="form-group col-md-12">
                            <a class="altarfc" style="cursor:pointer" data-toggle="modal" data-target="#exampleModal">Si no encuentras el RFC del propietario, dalo de alta aquí</a>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                    ...
                    <div class="form-row" align="right">
                        <div class="form-group col-md-12">
                            <a class="altarfc" style="cursor:pointer" data-toggle="modal" data-target="#exampleModal">Si no encuentras el RFC del comodatario, dalo de alta aquí</a>
                        </div>
                    </div>
                    <div class="form-row"> 
                        <div class="form-group col-md-12">
                    ...
                    <table width="100%">
                        <tr>
                            <td width="50%" valign="top">
								...
								<div class="form-group col-md-12">
                                    <input id="domiciliolicnum" name="domiciliolicnum" type="text" class="form-control" placeholder="Domicilio (número ext)*">
                                </div>
                                <div class="form-group col-md-12">
