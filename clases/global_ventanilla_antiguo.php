        ...
        $sql = "
            select *, case when docstotal = docsubidos then 1 else 0 end completo from
                ...
                *,
				...
				(select tramitecambio_folio from global_tramitecambio where tramitecambio_tramitevuid = tuv.tramitevu_id) as folio_tramitecambio,				
                (
                    select 
                    count(distinct documentosupload_tipodocumentosuploadid) 
                    from 
