...
class Xcrud
{
    ...
    {
        $tag = array('class' => 'xcrud-input xcrud-select-created');
    ...
    {
        exit('<div class="xcrud-error" style="position:relative;line-height:1.25;padding:15px;color:#BA0303;margin:10px;border:1px solid #BA0303;border-radius:4px;font-family: 'Montserrat', sans-serif;Arial,sans-serif;background:#FFB5B5;box-shadow:inset 0 0 80px #E58989;">
