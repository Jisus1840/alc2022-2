...
{
    // default connection
    public static $dbname = 'alcoholes'; // Your database name
    public static $dbuser = 'DavidAdame'; // Your database username
    public static $dbpass = 'D@dame2018'; // // Your database password
    public static $dbhost = '189.254.131.230'; // Your database host, 'localhost' is default.
    
    
    // theme and language
    public static $theme = 'alcoholes'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
